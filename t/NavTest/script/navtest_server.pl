...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{NAVTEST_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{NAVTEST_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
navtest_server.pl - Catalyst Testserver

=head1 SYNOPSIS

navtest_server.pl [options]
